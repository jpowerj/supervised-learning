...
* Download data [here](https://github.com/jpowerj/supervised-learning/blob/main/lab/nba_data_full.csv) (`nba_data_full.csv`)
  * Train neural net: **Classification** or **Regression**
  * **Prize** for discovering strongest indicators of (a) Playoffs (b) Point differential
